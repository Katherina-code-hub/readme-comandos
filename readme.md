Git clone: ele é um comando que é usado para baixar um repósitorio inteiro da internet para o seu computador com todos os arquivos e histórico. 
Git add: ele seleciona os arquivos que você quer salvar na próxima atualização.
